...
const createQuestionnaire = async () => {
  try {
    ...
    const response = await api.post('/questionnaire/create', questionnaireData);
    console.log('创建问卷响应:', response);
    ...
    <div class="content">
      <div class="questionnaire-form">
        ...
        <van-cell-group inset title="基本信息">
          ...
          >
            <template #input>
              <van-switch v-model="questionnaireForm.is_published" />
            </template>
          </van-field>
        </van-cell-group>
